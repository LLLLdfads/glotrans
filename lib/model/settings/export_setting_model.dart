...
class ExportSettingModel {
  ...
  ExportSettingModel changeAttr({
    ...
    return ExportSettingModel(
      ...
      isInsertBeforeL10nFlag:
          isInsertBeforeL10nFlag ?? this.isInsertBeforeL10nFlag,
      isInsertBeforeAndroidFlag:
          isInsertBeforeAndroidFlag ?? this.isInsertBeforeAndroidFlag,
    );
  }
}
